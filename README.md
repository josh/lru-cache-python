...
```sh
$ pip install https://github.com/josh/lru-cache-python/releases/download/v1.0.2/lru_cache-1.0.2-py3-none-any.whl
```

or just download the file:

```sh
$ curl -L https://github.com/josh/lru-cache-python/releases/download/v1.0.2/lru_cache.py >lru_cache.py
```
